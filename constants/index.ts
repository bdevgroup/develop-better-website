...
export const SiteVitrineModels = [
  {
    ...
    featured: true,
    icon: basePath + "/icon_quality.svg",
    imageThumbnail: "/templates/modele_gym2.webp",
    imageOrientation: "right",
    imageLandingFull: "/templates/modele_gym2.webp",
  ...
  },
  {
    ...
    featured: true,
    icon: basePath + "/icon_quality.svg",
    imageThumbnail: "/templates/modele_it2.webp",
    imageOrientation: "left",
    imageLandingFull: "/templates/modele_it2.webp",
  ...
  },
  {
    ...
    featured: true,
    icon: basePath + "/icon_quality.svg",
    imageThumbnail: "/templates/modele_cafe2.webp",
    imageOrientation: "right",
    imageLandingFull: "/templates/modele_cafe2.webp",
